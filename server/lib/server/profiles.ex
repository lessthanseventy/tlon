...
defmodule Server.Profiles do
  ...
  # The workspaces context to read policy through: this node's `Server.Workspaces`, or — on a
  # cockpit that is a CLIENT of the service (no Repo of its own) — its facade over erpc.
