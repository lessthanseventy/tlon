defmodule Mix.Tasks.Ast.Rename do
  @shortdoc "Rename an identifier AST-aware: mix ast.rename OLD NEW [--atoms] [--comments] FILE..."
  @moduledoc """
  `mix ast.rename old_name new_name [--atoms] [--comments] lib/a.ex lib/b.ex …`
  ...
  def run(argv) do
    ...
    case args do
      ...
      _ ->
        Mix.raise("usage: mix ast.rename OLD NEW [--atoms] [--comments] FILE...")
    end
  end
